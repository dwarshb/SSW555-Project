...
public class SignUp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        managercb = findViewById(R.id.mentor);
        workercb = findViewById(R.id.mentee);
    ...
    protected void selectItem(){
        workercb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (managercb.isChecked()){
        ...
        managercb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (workercb.isChecked()){
                    workercb.setChecked(false);
                }
                accounttype = "manager";
            }
        });
